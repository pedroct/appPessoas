...
import 'editar_pessoa_model.dart';
export 'editar_pessoa_model.dart';

class EditarPessoaWidget extends StatefulWidget {
  const EditarPessoaWidget({
    super.key,
    required this.pessoa,
  });

  final PESPessoaRow? pessoa;

  @override
  State<EditarPessoaWidget> createState() => _EditarPessoaWidgetState();
}

class _EditarPessoaWidgetState extends State<EditarPessoaWidget> {
  late EditarPessoaModel _model;
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title:
                                                              const Text('Atenção!'),
                                                          content: const Text(
                                                              'Você deseja atualizar essa Pessoa?'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                            ...
                                            if (confirmDialogResponse) {
                                              await PESPessoaTable().update(
                                                data: {
                                                  ...
                                                  'pes_genero':
                                                      _model.dpdGeneroValue,
                                                  'pes_estado_civil': _model
                                                      .dpdEstadoCivilValue,
                                                  'pes_escolaridade': _model
                                                      .dpdEscolaridadeValue,
                                                  'pes_cep': _model
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title:
                                                              const Text('Atenção'),
                                                          content: const Text(
                                                              'Você deseja remover esta Pessoa?'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
